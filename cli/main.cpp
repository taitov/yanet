...
std::vector<std::tuple<std::string,
        ...
        commands = {{"help", "", [](const auto& args) { call(help, args); }},
                    ...
                    {"neighbor", "", [](const auto& args) { call(route::summary, args); }},
                    {"neighbor get", "[route_name] [interface_name] [ip_address]", [](const auto& args) { call(route::summary, args); }},
                    {"neighbor insert", "[route_name] [interface_name] [ip_address] [mac_address]", [](const auto& args) { call(route::summary, args); }},
                    {"neighbor remove", "[route_name] [interface_name] [ip_address]", [](const auto& args) { call(route::summary, args); }},
